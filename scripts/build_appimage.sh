...
for f in repair.py gui.py classification.py defects.py mesh_classifier.py \
         mesh_classifier_v2.py autorefine.py triage.py engines.py ftetwild_manager.py manifold_bridge.py ftetwild_bridge.py indirect_bridge.py updater.py heatmap.py heatmap_render.py \

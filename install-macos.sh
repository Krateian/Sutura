...
for f in repair.py manifold_bridge.py classification.py confidence.py defects.py mesh_classifier.py updater.py gui.py heatmap.py heatmap_render.py before_after_render.py __init__.py; do

...
for f in repair.py manifold_bridge.py ftetwild_bridge.py indirect_bridge.py classification.py confidence.py defects.py mesh_classifier.py mesh_classifier_v2.py autorefine.py history.py updater.py gui.py heatmap.py heatmap_render.py before_after_render.py viewer_common.py viewer_data_render.py repair_score.py repair_score_config.json __init__.py; do
